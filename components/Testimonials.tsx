...
const testimonials = [
  {
    ...
    text: 'Easy Parking Ltd made everything simple. I booked online, drove to the terminal, and handed over my keys in minutes. My car was waiting when I landed—clean and secure. I\'ll definitely use them again.',
    rating: 5,
  },
  {
    name: 'Sarah',
