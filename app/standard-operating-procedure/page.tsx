...
export const metadata: Metadata = {
  title: "Standard Operating Procedure - Easy Parking",
  description: "Read our full standard operating procedure for Gatwick Meet & Greet parking: how to book, what to do on the day of your departure, and how collection works on arrival.",
  alternates: {
...
const sopSchema = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.easyparkingltd.com/standard-operating-procedure#webpage",
      "url": "https://www.easyparkingltd.com/standard-operating-procedure",
      "name": "Standard Operating Procedure - Easy Parking",
      "description": "Standard operating procedure for Gatwick Meet & Greet parking, covering the booking process, departure check-in and arrival collection.",
      "breadcrumb": {
        "@id": "https://www.easyparkingltd.com/standard-operating-procedure#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.easyparkingltd.com/standard-operating-procedure"
        }
      ]
    },
    {
      ...
      "step": bookingSteps.map((step, idx) => ({
        "@type": "HowToStep",
        "position": idx + 1,
        "text": step,
      })),
...
export default function StandardOperatingProcedurePage() {
  const navItems = [
    { anchor: "1", label: "On The Day Of Your Departure" },
    { anchor: "2", label: "On the Day of Arrival" },
    { anchor: "3", label: "Booking Process" },
  ...
  return (
    <div className="w-full bg-[#faf9f6] text-[#2c3e50] font-sans pb-20">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(sopSchema) }}
      />
      ...
      <section className="relative w-full h-[240px] md:h-[300px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Standard Operating Procedure Banner"
            fill
            sizes="100vw"
      ...
      <section className="max-w-[1320px] mx-auto py-12 lg:py-20 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
          ...
          <div className="w-full lg:w-3/4 flex flex-col gap-12 sm:gap-16">
            ...
            {/* --- SECTION 1: ON THE DAY OF YOUR DEPARTURE --- */}
            <article
              id="1"
            ...
            {/* --- SECTION 2: ON THE DAY OF ARRIVAL --- */}
            <article
              id="2"
              className="bg-white border border-gray-100 rounded-2xl p-6 sm:p-10 shadow-sm hover:shadow-md transition-shadow duration-300 border-t-4 border-t-[#e7701e]"
            >
            ...
            {/* --- SECTION 4: DIFFERENTLY ABLED INFO --- */}
            <article
              id="4"
              className="bg-white border border-gray-100 rounded-2xl p-6 sm:p-10 shadow-sm hover:shadow-md transition-shadow duration-300 border-t-4 border-t-[#e7701e]"
            >
                ...
                <div>
                  ...
                  <div className="text-[#555555] text-[14px] sm:text-[15px] leading-relaxed space-y-6">
                    <p className="font-semibold text-gray-700">
                      ...
                      <a href="tel:03330040262" className="text-[#e7701e] font-extrabold hover:underline">
                        0333 004 0262
                      </a>.
                    </p>
