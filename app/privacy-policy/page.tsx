            ...
            <div className="space-y-4 border-t border-gray-100 pt-6">
              ...
              <div className="space-y-4 pt-2">
                ...
                <ul className="space-y-4 pl-4 border-l-2 border-[#e7701e]/30">
                  ...
                  <li>
                    <strong className="text-[#002f5d]">Company</strong> (referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers to Easy Parking, London, United Kingdom.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong className="text-[#002f5d]">Website</strong> refers to Easy Parking, accessible from <a href="https://www.easyparkingltd.com/" target="_blank" rel="noreferrer noopener" className="text-[#e7701e] hover:underline">https://www.easyparkingltd.com</a>.
                  </li>
                  <li>
